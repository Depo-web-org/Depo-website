export default function ServiceItem({ title, description, image }) {
  return (
    ...
    >
      ...
      <div className="absolute bottom-14  left-0 w-full p-4 bg-primary bg-opacity-75 text-white transform translate-y-full group-hover:translate-y-16 transition-transform duration-500 ease-in-out">
