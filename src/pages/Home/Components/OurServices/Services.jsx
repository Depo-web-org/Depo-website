...
pageDots: false
  ...
  return (
    ...
    <section className='section-border '>
         <h2 className="text-white font-bold text-2xl lg:text-[32px]  text-start lg:text-center mt-8 mb-6 lg:mb-16">
     Our Services
