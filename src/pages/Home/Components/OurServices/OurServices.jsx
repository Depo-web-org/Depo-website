...
const OurServices = () => {
  const { t } = useTranslation(); 
    ...
    const servicesItems = {
      Graphic: { text: t('OurServices.Graphic'), Icon: <FaPenFancy /> },
      FrontEND: { text: t('OurServices.FrontEND'), Icon: <FaCode /> },
      Game: { text: t('OurServices.Game'), Icon: <TbDeviceGamepad2 /> },
      Accounting: { text: t('OurServices.Accounting'), Icon: <TbDeviceDesktopAnalytics /> },
      UIUX: { text: t('OurServices.UIUX'), Icon: <MdOutlineDesignServices /> },
      Testing: { text: t('OurServices.Testing'), Icon: <SiVitest /> },
      Mobile: { text: t('OurServices.Mobile'), Icon: <CiMobile2 /> },
    };
  ...
  return (
    <section className='section-border py-6 lg:py-0 '>
     ...
     {t('OurServices.title-OurServices')}
