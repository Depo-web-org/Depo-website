  ...
  return (
    <div className="h-[406px] p-2 gap-2 rounded-[16px] bg-white shadow-lg">
      ...
      <div className="w-full h-[62px] flex justify-between items-center bg-white">
        <p>{subtitle}</p>
        <ViewButton onClick={handleModalToggle} />
      </div>
...
function ViewButton({ onClick }) {
  return (
    <button
      className="w-[90px] h-[45px] px-8 py-4 gap-2 rounded-[23px] border text-center flex items-center justify-center border-secondary bg-white text-black"
      onClick={onClick}
    >
      View
    </button>
